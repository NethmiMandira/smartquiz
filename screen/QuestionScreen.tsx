...
const QuestionScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Save the question under quizzes/{quizId}/questions with auto-generated ID
      ...
      // Update the doc to add questionId field (the auto-generated ID)
      await updateDoc(doc(db, "quizzes", quizId, "questions", docRef.id), {
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.subtitle}>Add a new question to your {subject} quiz</Text>
        </View>
